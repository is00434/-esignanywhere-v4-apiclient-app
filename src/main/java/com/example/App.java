...
import osplus.esignanywhere.v4.ESignAnywhereClient;
import osplus.esignanywhere.v4.ESignAnywhereClientException;
...
public class App implements Runnable {
    ...
    private ESignAnywhereClient esignAnywhereClient = null;

    private ESignAnywhereClient getESignAnywhereClient() {
    ...
    */
    ...
    public void run() {
        try {
            final FlowApiResult version = getESignAnywhereClient().getVersion();
            System.out.println("Version: " + version);

            final UploadSspFileResult sspUploadFileResult1 = getESignAnywhereClient().uploadFile(getTestPdf());
            System.out.println("UploadSspFileResult1: " + sspUploadFileResult1);

            final UploadSspFileResult sspUploadFileResult2 = getESignAnywhereClient().uploadFile("Test2.pdf", getTestPdfAsByteArray());
            System.out.println("UploadSspFileResult2: " + sspUploadFileResult2);

            final UploadSspFileResult sspUploadFileResult3 = getESignAnywhereClient().uploadFile("Test3.pdf", getTestPdfAsByteArray());
            System.out.println("UploadSspFileResult3: " + sspUploadFileResult3);
            ...
            final SendEnvelopeResult sendEnvelopeResult = getESignAnywhereClient().sendEnvelope(envelopeSendModel);
            System.out.println("SendEnvelopeResult: " + sendEnvelopeResult);
